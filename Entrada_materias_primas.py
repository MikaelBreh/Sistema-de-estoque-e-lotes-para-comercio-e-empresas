...
from Banco_de_dados.Insert import insert_data_entrada
...
def Entrada_Materias_primas():
    ...
    while True:
        ...
        if event == 'OK':
            ...
            insert_data_entrada('entrada_materias_primas', values['Fornecedor'], values['Produto'], int(values['Quantidade']), values['Lote'],
                            values['Data'])
