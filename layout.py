...
def menu_principal():
    ...
    layout = [
        ...
        [sg.Button('Estoque', font=fonte_button, size=(10, 2)), sg.Button('Consultas', font=fonte_button, size=(10, 2))],
...
def entrada_mat_primas():
    sg.theme('Reddit')
    layout = [
        [sg.Text('Fornecedor', font=fonte), sg.OptionMenu(values=forncedores, size=(8, 12), default_value='selecionar', key='Fornecedor')],
        [sg.Text('Produto', font=fonte),sg.OptionMenu(values=valores,size=(8,12), default_value='selecionar',key='Produto')],
...
def criar_ordem_producao():
    sg.theme('Reddit')
    layout = [
        [sg.Text('Produto'),sg.OptionMenu(values=produtos_acabados,size=(8,12), default_value='selecionar',key='Produto')],
        [sg.Text('Numero Ordem', font=fonte), sg.Input(key='Numero Ordem', font=fonte_box)],
        [sg.Text('Quantidade', font=fonte), sg.Input(key='Quantidade', font=fonte_box)],
        [sg.Text('Lote 1', font=fonte), sg.Input(key='Lote_1', font=fonte_box)],
        [sg.Text('Lote 2', font=fonte), sg.Input(key='Lote_2', font=fonte_box)],
        [sg.Text('Lote 3', font=fonte), sg.Input(key='Lote_3', font=fonte_box)],
        [sg.Text('Lote 4', font=fonte), sg.Input(key='Lote_4', font=fonte_box)],
        [sg.Text('Data', font=fonte), sg.Input(key='Data', font=fonte_box)],
...
def consulta():
    ...
    layout = [
        ...
        [sg.Text('Por Materia Prima', font=fonte),sg.OptionMenu(values=valores,size=(4,8), default_value='selecionar',key='Por Materia Prima')],
        [sg.Text('Por Produto Acabado', font=fonte), sg.OptionMenu(values=produtos_acabados, size=(4, 8), default_value='selecionar', key='Por Produto Acabado')],
